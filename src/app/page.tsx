...
export default function Home() {
  ...
  return (
    <main className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black">
          ...
          >
            ...
            >
              ...
              <div className="flex items-center gap-2 px-4 py-2 rounded-full glass border border-aurora-violet/30">
                <Lock className="h-4 w-4 text-aurora-violet" />
              ...
              <div className="flex items-center gap-2 px-4 py-2 rounded-full glass border border-aurora-cyan/30">
                <Database className="h-4 w-4 text-aurora-cyan" />
            ...
            >
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-aurora-violet">&gt; Neural Networks: ACTIVE</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="h-2 w-2 rounded-full bg-aurora-cyan" />
                <span className="text-aurora-cyan">&gt; Blockchain Nodes: SYNCED</span>
              </div>
              <div className="flex items-center gap-2">
            ...
            >
              <motion.button
                ...
                className={`
                  ...
                  hover:shadow-[0_0_50px_rgba(82,39,255,0.6)]
      ...
      <div className="absolute bottom-0 right-0 w-32 h-32 border-r-2 border-b-2 border-[#FF00D6]/20 rounded-br-3xl" />
    </main>
  );
}
