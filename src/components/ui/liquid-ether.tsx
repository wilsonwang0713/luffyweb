  ...
  useEffect(() => {
    ...
    class MouseClass {
      ...
      init(container: HTMLElement) {
        ...
        container.addEventListener('touchstart', this._onTouchStart as any, false);
        container.addEventListener('touchmove', this._onTouchMove as any, false);
      ...
      dispose() {
        ...
        this.container.removeEventListener('touchstart', this._onTouchStart as any, false);
        this.container.removeEventListener('touchmove', this._onTouchMove as any, false);
...
`;
    ...
    class Simulation {
      ...
      update() {
        if (!this.advection || !this.externalForce || !this.divergence || !this.poisson || !this.pressure) return;
